...
class InterfaceBot:
    def __init__(self, Proxys, camera, xmax, ymax):
        ...
        self.xmax=xmax
        self.ymax=ymax
        self.Pos=fct.calcul_pos(xmax,ymax,camera.focus)
        self.cam=camera
    ...
    def change_objectif(self,focus):
        self.camera.newfocus(focus)
        self.Pos=fct.calcul_pos(self.xmax,self.ymax,focus)
